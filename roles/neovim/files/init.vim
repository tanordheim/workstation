...
set undodir=~/.config/nvim/tmp/undo/ " set the directory where undo history is stored
set backupdir=~/.config/nvim/tmp/backup/ " set the directory where backups are stored
set directory=~/.config/nvim/tmp/swap/ " set the directory where swap files and other junk is stored
...
let g:airline_theme = 'nord' " set the color scheme
